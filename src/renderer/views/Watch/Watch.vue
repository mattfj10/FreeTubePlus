  ...
  >
    ...
    >
      <div class="videoAreaMargin">
        <!--
          KeepAlive moves cached views into a hidden container; browsers pause <video> there.
          While this tab is in the background, teleport the player to body so playback can continue.
        -->
        <Teleport
          to="body"
          :disabled="!isKeepAliveInactive"
        >
          <div
            class="watchPlayerTeleportHost"
            :class="{ watchPlayerTeleportHostBackground: isKeepAliveInactive }"
          >
